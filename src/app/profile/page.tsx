...
const Profile = () => {
	...
	const handleSaveChanges = async () => {
		...
		const fieldsToUpdate = {
			...
			timezone:
				editedTimezone !== user.timezone ? editedTimezone : undefined,
			notif_change:
				notifChange !== toBool(user.notif_change)
					? notifChange
					: undefined,
			notif_guides:
				notifGuides !== toBool(user.notif_guides)
					? notifGuides
					: undefined,
			notif_articles:
		...
		Object.entries(fieldsToUpdate).forEach(([key, value]) => {
			if (value !== undefined) {
				(updateData[key as keyof typeof updateData] as typeof value) =
					value;
			}
		});
						...
						<div className="flex-col flex sm:flex-row border-4 gap-[24px] border-transparent">
							<div className="relative w-[64px] h-[64px] md:w-[73px] md:h-[73px] lg:w-[83px] lg:h-[83px] flex-shrink-0">
								<Image
									src={
										avatarPreview ||
										(user?.avatar ? user.avatar : avatarImg)
									}
									alt="Avatar"
							...
							<div className="flex flex-col gap-4">
								<div>
									...
									<p className="max-w-[350px] sm:w-[350px] leading-[18px] text-[#949392]">
										Subscribe to our bot to receive
										notifications about changes to favorite
										guides, publication of new guides and
										articles.
									</p>
								</div>
									...
									<div className="flex gap-2 mb-3">
										...
										<div>
											...
											<p className="w-full md:w-[250px] sm:w-full leading-[18px] text-[#949392]">
												Use your email to protect your
